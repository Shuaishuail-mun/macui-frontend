        ...
        <div className={`${style.ApplicationBar} fixed-bottom d-flex justify-content-center align-items-center`}>
            <div className={`${style.Dock}`}>
                <ul className={style.List}>
                    ...
                    <li><span>Email</span><img src={mail}/></li>
                    <li><span>Music</span><img src={music}/></li>
                    <li><span>Photo</span><img src={photo}/></li>
                    <li><span>Photoshop</span><img src={ps}/></li>
                    <li><span>Terminal</span><img src={terminal}/></li>
                    <li><span>Twitter</span><img src={twitter}/></li>
                </ul>
            </div>
        </div>
    );
